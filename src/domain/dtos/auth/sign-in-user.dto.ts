...
export class SignInUserDto {
     ...
     static signIn(object: { [key: string]: any }): [string?, SignInUserDto?] {
          ...
          return [
               undefined,
               new SignInUserDto(email, password, address, firstName, lastName, phoneNumber, imageProfilePath, city, zipcode, lockoutEnabled, accessFailedCount, birthDate, roles, permissions)
          ];
     }
