     ...
     (
          {
               ...
               productImages: { type: [Schema.Types.ObjectId], ref: 'ProductImages' },
               productVideos: { type: [Schema.Types.ObjectId], ref: 'ProductVideos' },
               variants: { type: [Schema.Types.ObjectId], required: [true, 'Variants are required'], ref: 'Variants' },
